...
import com.listadetarefas.db.TaskContract;
import com.listadetarefas.db.TaskDBHelper;
        ...
        builder.setPositiveButton("Adicionar",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        helper = new com.listadetarefas.db.TaskDBHelper(MainActivity.this);
                        SQLiteDatabase db = helper.getWritableDatabase();
                        ContentValues values = new ContentValues();

                        values.clear();
                        values.put(com.listadetarefas.db.TaskContract.Columns.TAREFA, tarefa);

                        db.insertWithOnConflict(com.listadetarefas.db.TaskContract.TABLE, null, values,
